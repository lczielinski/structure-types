...
(* augmenters *)
assume val augment_lower_unitdiag : #n:pos -> sq_mat n Lower UnitDiag ->
    cvec n -> sq_mat (n + 1) Lower UnitDiag

(* destructors *)
assume val destruct_lower_unitdiag : #n:pos -> sq_mat (n + 1) Lower UnitDiag ->
    cvec n * sq_mat n Lower UnitDiag

(* destructing then augmenting recovers the original matrix *)
assume val augment_destruct_inv : #n:pos -> l:sq_mat (n + 1) Lower UnitDiag ->
    Lemma (ensures (let c, l' = destruct_lower_unitdiag #n l in
                    augment_lower_unitdiag l' c == l))
    [SMTPat (destruct_lower_unitdiag #n l)]
...
assume val mat_mul_augment : #n:pos ->
    a:sq_mat n Lower UnitDiag -> u:cvec n ->
    b:sq_mat n Lower UnitDiag -> v:cvec n ->
    ...
    [SMTPat (augment_lower_unitdiag a u); 
     SMTPat (augment_lower_unitdiag b v)]
