...
(* add vectors *)
let rec vec_add (#o: orient) (#n: pos) (v1 v2: vec o n) : r: vec o n 
  {(is_zero_vec v1 ==> r == v2) /\ (is_zero_vec v2 ==> r == v1)} =
  match v1 with
  | Vec1 x -> let Vec1 y = v2 in Vec1 (scalar_add x y)
  | VecN v1' x -> let VecN v2' y = v2 in VecN (vec_add v1' v2') (scalar_add x y)

(* negate a vector *)
let rec vec_neg (#o: orient) (#n: pos) (v: vec o n) : r: vec o n 
  {is_zero_vec v ==> is_zero_vec r} =
  match v with
...
(* vector-scalar mul *)
let rec vec_scalar_mul (#o: orient) (#n: pos) (v: vec o n) (a: num) : r: vec o n
  {(is_one a ==> r == v) /\ (is_zero_vec v ==> is_zero_vec r) /\ (is_zero a ==> is_zero_vec r)} =
  match v with
...
(* vector-scalar div *)
let rec vec_scalar_div (#o: orient) (#n: pos) (v: vec o n) (a: num{is_nnz a}) : r: vec o n 
  {vec_scalar_mul r a == v} =
  match v with
...
(* transpose vector *)
let rec vec_trans (#o: orient) (#n: pos) (v: vec o n) : r: vec (flip o) n 
  {is_zero_vec v ==> is_zero_vec r} =
  match v with
  | Vec1 x -> Vec1 x
